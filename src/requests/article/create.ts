...
const createArticleSchema = z.object({
  ...
  hashtags: z.array(z.string()).default([]), // ✅ default ke array kosong
});

export async function createArticleRequest(articleData: Omit<NewArticle, 'slug'>) {
  ...
  try {
    await useArticleStore.getState().createArticle(result.data);
